...
wget -P /minecraft/server1/plugins https://ci.m.ly/job/Minecraftly/lastSuccessfulBuild/artifact/bukkit-1.8/build/libs/Minecraftly-1.0-SNAPSHOT.jar
wget -P /minecraft/server2/plugins https://ci.m.ly/job/Minecraftly/lastSuccessfulBuild/artifact/bukkit-1.8/build/libs/Minecraftly-1.0-SNAPSHOT.jar
...
wget -P /minecraft/proxy1/plugins https://ci.m.ly/job/Minecraftly/lastSuccessfulBuild/artifact/bungeecord-1.8/build/libs/MinecraftlyBungee-1.0-SNAPSHOT.jar
wget -P /minecraft/proxy2/plugins https://ci.m.ly/job/Minecraftly/lastSuccessfulBuild/artifact/bungeecord-1.8/build/libs/MinecraftlyBungee-1.0-SNAPSHOT.jar
wget -P /minecraft/proxy1/plugins/MinecraftlyBungee https://raw.githubusercontent.com/minecraftly/minecraftly/master/bungeecord-1.8/config.yml
wget -P /minecraft/proxy2/plugins/MinecraftlyBungee https://raw.githubusercontent.com/minecraftly/minecraftly/master/bungeecord-1.8/config.yml
wget -P /minecraft/proxy1/plugins/MinecraftlyBungee https://raw.githubusercontent.com/minecraftly/minecraftly/master/bungeecord-1.8/motd.yml
wget -P /minecraft/proxy2/plugins/MinecraftlyBungee https://raw.githubusercontent.com/minecraftly/minecraftly/master/bungeecord-1.8/motd.yml
